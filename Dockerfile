...
RUN apt-get update && \
    ...
    xvfb x11vnc x11-xkb-utils xfonts-100dpi xfonts-75dpi xfonts-scalable xfonts-cyrillic dbus-x11 x11-apps \
    nginx
...
RUN mkdir -p ~/.vnc && x11vnc -storepasswd Thin1ziews ~/.vnc/passwd
